...
?>
	<h4 class="fw-bolder text-center">yeni makale ekle</h4>
	<center>
				...
				<div class="card-body">
					<div class="container-fluid">
						...
						<form method="post" action="admin_add.php" enctype="multipart/form-data">
								<div class="mb-3">
									<label class="control-label">makale no</label>
								...
								<div class="mb-3">
									...
									<textarea class="form-control rounded-0" name="descr" cols="40000" rows="5"></textarea>
								</div>
								<div class="mb-3">
								...
								<div class="mb-3">
									<label class="control-label">yayınlayıcı</label>
								...
								<div class="text-center">
									...
									<button type="reset" class="btn btn-default btn-sm rounded-0 border">çık</button>
								</div>
						</form>
					</div>
				</div>
